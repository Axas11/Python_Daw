...
#Los jugadores del Atlético de Madrid que van a la Selección Española.
#Los jugadores del Atlético de Madrid que van a la Selección Española y que son titulares tanto en el Atlético como en la Selección. 
print("Los jugadores del Atlético de Madrid que van a la Selección Española son:")
filtrados = []
for persona in jugadores:
    for persona2 in seleccion_espanola:
        if persona.nombre == persona2.nombre:
            filtrados.append(persona)

for persona in filtrados:
    print(persona.nombre)

print("Los jugadores del Atlético de Madrid que van a la Selección Española y que son titulares tanto en el Atlético como en la Selección son:")
filtrados = []
for persona in jugadores:
    for persona2 in seleccion_espanola:
        if persona.nombre == persona2.nombre and persona2.titular == True:
            filtrados.append(persona)
